...
public class MainActivity extends Activity implements View.OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// MemoInformation memoInfoUn = new
		// MemoInformation("Title: acheter medicament","description: pour mal de tete ","Traverse d'Esope 5, 1348");
		MemoInformation memoInfoUn = new MemoInformation(" acheter medicament",
				"pour mal de tete ", "Traverse d'Esope 5, 1348");

		db.addMemoInformation(memoInfoUn);
		Log.d("ONE ************************** ", "**********************");

		MemoInformation memoInfoDeux = new MemoInformation(
				"livre calculabilit�", "biblio INGI ",
	...
	/**
	 * final Button NewMemo = (Button) findViewById(R.id.new_memo);// A changer
	 * par m�thode plus propre NewMemo.setOnClickListener(new
	 * View.OnClickListener() { public void onClick(View v) { Intent
	 * WriteNewMemo = new Intent(MainActivity.this, WriteNewMemo.class);
	 * startActivity(WriteNewMemo); } });
	 * 
	 * 
	 * final Button OpenMap = (Button) findViewById(R.id.open_map);// A changer
	 * par m�thode plus propre OpenMap.setOnClickListener(new
	 * View.OnClickListener() { public void onClick(View v) { Intent Map = new
	 * Intent(MainActivity.this, Map.class); startActivity(Map); } });
	 **/
	// button to list memo in the main activity
	/**
	 * final Button ListMemo = (Button) findViewById(R.id.list_memo);// A
	 * changer par m�thode plus propre ListMemo.setOnClickListener(new
